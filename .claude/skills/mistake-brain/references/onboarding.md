...
A fresh `MISTAKES.md` looks like this — just the header and the insertion marker, no entries:

```md
# MISTAKES.md

Raw, append-only log of failures, corrections, and reverted changes for this agent. Newest entries go directly below this header...
